...
rm(PSMs, peptide_proteins_graph, peptide_proteins, all_proteins_input)
gc()

# Process isoforms ---
## onePot
MSstatsTMT_input[, log2Intensity := log(Intensity, 2)]
onepot_graph_procd = createPeptideProteinGraph(MSstatsTMT_input)
MSstatsTMT_input = addClusterMembership(MSstatsTMT_input, onepot_graph_procd)
...
rm(MSstatsTMT_input_iso_graph)

# Cluster statistics ----
MSstatsTMT_input_iso = getClusterStatistics(MSstatsTMT_input_iso, TRUE)

# Make input for next steps
onepot_int_cls_tbl = MSstatsTMT_input_iso
rm(PSMs, annotations, onepot_graph_procd, MSstatsTMT_input, MSstatsTMT_input_iso)
...
rm(onepot_int_cls_each_uni, onepot_int_cls_tbl)
