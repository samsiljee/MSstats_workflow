...
MSstats.results$Colour <- ifelse(MSstats.results$log2FC > 1 & MSstats.results$adj.pvalue < 0.05, "Upregulated",
ifelse(MSstats.results$log2FC < 1 & MSstats.results$adj.pvalue < 0.05), "Downregulated", "Not significant")
...
ggplot(MSstats.results, aes(x = log2FC, y = -log10(adj.pvalue))) +
