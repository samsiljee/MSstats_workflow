...
# read main data
raw_IT <- read.csv("data/OT_vs_IT/Pilot_22-091_1ul_50cm_IT_PSMs.txt", stringsAsFactors = TRUE)
raw_OT <- read.csv("data/OT_vs_IT/Pilot_22-091_1ul_50cm_OT_PSMs.txt", stringsAsFactors = TRUE)
